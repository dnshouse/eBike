...
class LeftSidebar extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            avgSpeed: 17.8,
            tripDistance: 30.2,
            odoMiles: Numeral(16755.56).format("0,0.[0]")
        }
    };
            ...
            <View style={styles.container}>
                <TouchableOpacity onPress={this.onAvgSpeedPress} onLongPress={this.onAvgSpeedLongPress} style={[styles.box, styles.borderBottom]}>
                    <View>
                        ...
                        <Text style={styles.value}>{this.state.avgSpeed}</Text>
                ...
                <TouchableOpacity onPress={this.onTripDistancePress} style={[styles.box, styles.borderBottom]}>
                    <View>
                        ...
                        <Text style={styles.value}>{this.state.tripDistance}</Text>
                ...
                <View style={styles.box}>
                    ...
                    <Text style={styles.value}>{this.state.odoMiles}</Text>
